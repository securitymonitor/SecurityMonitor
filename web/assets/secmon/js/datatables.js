    ...
    tableElement.dataTable( {
		"sDom": "<'row'<'col-md-6'l T><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
			...
			"aButtons": [
				{
					"sExtends":    "text",
					"sButtonText": "<button type='submit' class='btn btn-white'><i class='fa fa-search'></i>",
				}
			]
		},
		"sPaginationType": "bootstrap",
    ...
    var oTable = $('#example2').dataTable( {
		"sDom": "<'row'<'col-md-6'l T><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
			...
			"aButtons": [
				{
					"sExtends":    "text",
					"sButtonText": "<button type='submit' class='btn btn-white'><i class='fa fa-plus'></i></button><button type='submit' class='btn btn-white'><i class='fa fa-pencil'></i></button><button type='submit' class='btn btn-white'><i class='fa fa-minus'></i></button>",
				}
			]
		},
		"sPaginationType": "bootstrap",
