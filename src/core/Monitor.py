    ...
    def startMonitoring(self,dirConfig,dirLog,startAt):
        ...
        for i in range(startAt,len(logLines)):
            for j in range(0,len(ruleLines)):
                ...
                if(int(count)==(int(ruleCount[1])*2)):
                    startElement=i-(int(ruleCount[1])*2)
                    dateTimeStart=connectionTime[startElement]
                    dateTimeNow=connectionTime[i]
                    ...
                    if(timeRange<int(ruleTime[1])and(int(count)==(int(ruleCount[1])*2))):
                        errorType = 1;
                        ...
                        print "mail is triggered "+str(int(count))+"=="+str(int(ruleCount[1])*2)+"\n"+str(timeRange)+">"+str(int(ruleTime[1]))     
